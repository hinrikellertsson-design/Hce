  ...
  return (
    <div className="flex items-center justify-between gap-3">
      ...
      <button
        ...
        className="flex items-center gap-1.5 rounded-[4px] border border-border px-3 py-2 text-[12px] font-medium text-ink-muted hover:border-accent active:border-accent transition-colors"
      >
